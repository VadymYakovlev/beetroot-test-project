...
// 1.1 Отримати інфо про авто
  getInfoCar: function () {
    ...
    console.log('Середня витрата палива на 100 км: ' +this['середня витрата палива на 100 км']);
...
function updateSeconds(time, addedSeconds) {
  let actualTimeInSeconds = time.hours * 3600 + time.minutes * 60 + time.seconds;
